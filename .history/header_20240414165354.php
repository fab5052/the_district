...
<a href="contact.php">Contact</a>
      ...
      <div class="nav-authentication col-md-5   m-3  d-flex align-items-center vertical-align-baseline">
        <a href="profile.php"><i class="fas fa-user-circle d-md-flex d-sm-block"></i>Profile</a>
