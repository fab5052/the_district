  ...
  <header>
    ...
    <nav>
      ...
      <div class="main-navlinks">
        <bouton type="button" class=" toggle m-5 my-auto vertical-align-top " aria-label="Toggle Menu" aria-expanded="false">
          <span></span>
          <span></span>
          <span></span>
          </button>
      ...
      <div class="navlinks-container col-md-4 d-flex justify-items-center justify-content-evenly ">
...
<a href="contact.php">Contact</a>
      ...
      <div class="nav-authentication d-flex position-relative  col-md-3  m-sm-0 ">
        <a href="profile.php"><i class="fas fa-user-circle  d-block"></i>Profile</a>
