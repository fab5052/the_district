...
<a href="contact.php">Contact</a>
      ...
      <div class="nav-authentication col-md-6  col-sm-8  m-3  align-items-center vertical-align-baseline">
        <a href="profile.php"><i class="fas fa-user-circle d-lg-flex d-sm-block"></i>Profile</a>
        <a href="logout.php"><i class="fas fa-sign-out-alt d-md-flex d-sm-block "></i>Logout</a>
