...
class Categorie {
    ...
    public function afficher_cat_page() {
        echo "<h1 class='d-flex vertical-align-middle justify-content-center align-items-center text-uppercase position-absolute' >"  . $this->getLibelle() . "</h1>
           <div class='accordion-body d-block vertical-align-middle justify-content-center align-items-baseline '  >
            <a href='plat_cat.php?id=" . $this->getId() . "'>
            <img class='img-fluid   ' src='" . $this->getImage() . "'>
            </a>
        </div>";
