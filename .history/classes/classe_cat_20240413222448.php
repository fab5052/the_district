...
class Categorie {
    ...
    public function afficher_index_page() {
        echo "<h1 class='d-flex position-relative justify-content-center  align-items-center'>" . $this->getLibelle() . "</h1>
    ...
    public function afficher_cat_page() {
        echo "<h2 class=' position-absolute align-items-center text-uppercase' >"  . $this->getLibelle() . "</h2>
