...
// Méthodes pour obtenir et définir la propriété id_categorie
    ...
    public function afficher_plat_view() {
        // $categorie = get_categorie($this->getIdCategorie() {
        echo "<div>
        <img class=' img-fluid' src ='".$this->getImage()."' alt='#".$this->getLibelle()."'>
        <div class= class='card-plat '>
            <h2 class='card-title'>".$this->getLibelle()." / ".$this->getLibelle()."</h2>
