...
<a class="active:hover" href="index.php" aria-current="page">Accueil</a>
<a class="active" href="categorie.php" aria-current="page">Catégories</a>
<a class="active" href="plat.php" 
aria-current="page">Plats</a>
