...
<a href="contact.php">Contact</a>
      ...
      <div class="nav-authentication position-relative  col-md-3 d-flex vertical-align-middle  ">
        <a href="profile.php"><i class="fas fa-user-circle  d-sm-block"></i>Profile</a>
        <a href="logout.php"><i class="fas fa-sign-out-alt d-block "></i>Logout</a>
        <a href="shopping.php"> <i class="fas fa-shopping-cart red d-block-"></i> <span class="badge badge-red p-0">0</span></a>
