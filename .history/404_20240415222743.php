		...
		<div class="container">
			<div class="row">
				...
				<div class="span4">
					<div class="block_3">
						<h2>Sorry!</h2>
				<img href="assets/img/Not_Found_404.png">		<p class="txt_1">The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.<br><br>Please try using our search box below to look for information on the website
						</p>
						<div id="search">
