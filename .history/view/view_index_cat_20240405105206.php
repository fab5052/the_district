...
if ($Currentpage == "index.php") {
    ...
    echo "<h1 class='row d-flex position-relative mt-8'>Nos clients en raffolent !!</h1>
          <div class='row card-plat m justify-content-between  position-relative'>";
    foreach ($plats_index as $plat) {
        echo "<div  class='container-fluid ul w-80 mx-auto justify-content-center'>";
