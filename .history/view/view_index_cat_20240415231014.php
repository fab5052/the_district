...
if ($Currentpage == "categorie.php")  {
  ...
  $categories = get_plat_cat($conn, $id); {
  echo "<hr><h1 class=' d-flex position-relative justify-content-center'>Nos clients en raffolent !!</h1>
        <div class='card-index onmouseover  row container-fluid pt-4 ml-4 p-0 '>";
  foreach ($categories as $categorie) {
      echo "<div  class='col-md-4 mx-auto justify-content-center justify-align-items-center  position-relative '>";
