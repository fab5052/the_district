...
if ($Currentpage == "index.php") {
    ...
    echo "<h1 class='mb-10 d-flex justify-content-center pt-8'>BEST-SELLERS</h1><br><br>
          <div  class='container-fluid ul mb--6 d-flex w-80 mx-auto justify-content-center'>";
    ...
    echo "<hr><h2 class=' d-flex position-relative justify-content-center'>Nos clients en raffolent !!</h2>
...
if ($Currentpage == "categorie.php")  {
  ...
  echo "<div class='ul accordion-group'>";
  foreach ($categories as $categorie) {
  echo "<li class='text-uppercase  row mx-auto text-uppercase ' style='uppercase' >";
