...
if ($Currentpage == "index.php") {
    ...
    echo "<h1 class='d-flex justify-content-center'>BEST-SELLERS</h1>
    ...
    echo "<h2 class='d-flex position-relative pt-4'>Nos clients en raffolent !!</h2>
          <div >";
    foreach ($plats_index as $plat) {
        echo "<div  class='container-fluid card-plat  mx-auto  position-relative '>";
