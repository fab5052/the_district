...
if (isset($_POST['email'], $_POST['subject'], $_POST['name'], $_POST['msg'])) {
	...
	if (!$responses) {
		// Where to send the mail? It should be your email address use PHPMailer\PHPMailer\PHPMailer;
...
try {
    ...
    $mail->isSMTP();
    $mail->Host = 'localhost';
    $mail->Port = 1025; // Port par défaut de MailHog$mail->setFrom('thedistrict@mail.com', 'Expediteur');
