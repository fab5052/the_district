...
<a href="contact.php">Contact</a>
      ...
      <div class="nav-authentication col-md-6   m-3  d-flex align-items-center vertical-align-baseline">
        <a href="profile.php"><i class="fas fa-user-circle d-md-block"></i>Profile</a>
        <a href="logout.php"><i class="fas fa-sign-out-alt d-md-block justify-content-baseline"></i>Logout</a>
        <a href="shopping.php"> <i class="fas fa-shopping-cart red m-0 p-0 "></i> <span class="badge badge-red">0</span></a>
