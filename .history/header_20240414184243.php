  ...
  <header>
    ...
    <nav>
      ...
      <div class="main-navlinks">
        <bouton type="button" class=" toggle m-5" aria-label="Toggle Menu" aria-expanded="false">
          <span></span>
          <span></span>
          <span></span>
          </button>
...
<div class="navlinks-container col-md-4 ml-2 d-flex justify-content-evenly ">
...
<a href="contact.php">Contact</a>
      ...
      <div class="nav-authentication position-relative  col-md-3 d-flex vertical-align-middle my-auto ">
        ...
        <a href="shopping.php"> <i class="fas fa-shopping-cart red d-flex"></i> <span class="badge badge-red my-auto">0</span></a>
