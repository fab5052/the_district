...
<div class="recentlyadded content-wrapper">
 ...
 <div class="container-fluid p-0 pb-4  ">
  ...
  <?php foreach ($categories as $categorie) {
    echo "<div class='li d-none d-block text-uppercase ' onmouseover='affiche_plats_cat(" . $categorie->getId() . ")'>";
...
?>
      ...
      <script>       
      function affiche_plats_cat(categorieId) {
    // Faire une requête AJAX vers le serveur pour récupérer les plats de la catégorie
    var xhr = new XMLHttpRequest();
    xhr.onreadystatechange = function() {
        if (xhr.readyState == 4 && xhr.status == 200) {
            // Mettre à jour une partie de la page avec les plats récupérés
            document.getElementById("plats_cat_container").innerHTML = xhr.responseText;
        }
    };
    xhr.open("GET", "get_plats_cat.php?id=" + categorieId, true); // Utilisez 'id' comme paramètre dans l'URL
    xhr.send();
}
  ...
  <div class="container-fluid justify-content-between  mr-2 ml-1 position-relative w-100 ">
