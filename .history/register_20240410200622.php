...
if (isset($_POST['username'], $_POST['password'], $_POST['confirm_password'], $_POST['email'])) {
    ...
    try {
        ...
        $activate_link = 'http://thedistrict@phplogin/activate.php?email=' . $_POST['email'] . '&code=' . $uniqid;
...
// }
	...
	// 	// Destinataire
	// 	$mail->setFrom('thedistrict@mail.com', 'Expediteur');
	// 	$mail->addAddress($_POST['email'], $subject, $message, $headers); // Adresse email du destinataire et nom du destinataire

	// 	// Contenu du message
	// 	$mail->isHTML(true);
	// 	$mail->Subject = 'Account Activation Required';
	// 	$headers = 'From: ' . $from . "\r\n" . 'Reply-To: ' . $from . "\r\n" . 'X-Mailer: PHP/' . phpversion() . "\r\n" . 'MIME-Version: 1.0' . "\r\n" . 'Content-Type: text/html; charset=UTF-8' . "\r\n";
	// 	$activate_link = 'http://thedistrict@mail.com/phplogin/activate.php?email=' . $_POST['email'] . '&code=' . $uniqid;
