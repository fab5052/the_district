...
<div class="recentlyadded content-wrapper">
 ...
 <li class="d-none d-block text-uppercase vertical-text onmouseover='affiche_plats_cat'">
<!-- 
...
require_once('view/view_plat_page_cat.php');
...
<script>
    function affiche_plats_cat(categorieId) {
        ...
        xhr.open("GET", "get_plats_cat.php?categorieId=" + categorieId, true);
        xhr.send();
    }
</script>
