...
<body>
  ...
  <header>
    ...
    <nav>
      ...
      <div class="navlinks-container col-md-4 d-flex justify-items-center">
      ...
      <div class="nav-authentication col-md-4 my-auto mx-auto m-3 d-flex d-md-block justify-content-evenly align-items-center vertical-align-middle">
        <a href="profile.php"><i class="fas fa-user-circle"></i>Profile</a>
        <a href="logout.php"><i class="fas fa-sign-out-alt"></i>Logout</a>
        <a href="shopping.php"> <i class="fas fa-shopping-cart red "></i> <span class="badge badge-red">0</span></a>
      <!-- <div class="nav-authentication position-relative  col-md-4 d-flex d-md-block my-auto ">
        <a href="profile.php"><i class="fas fa-user-circle  d-sm-block my-auto "></i>Profile</a>
        <a href="logout.php"><i class="fas fa-sign-out-alt d-sm-block "></i>Logout</a>
        <a href="shopping.php"> <i class="fa fa-shopping-cart red d-flex"></i> <span class="badge badge-red my-auto">0</span></a> -->
